  ...
  <button
    ...
    :class="[
      ...
      classes,
      {
        ...
        'border-gray-600 text-qwerty-white bg-transparent cursor-not-allowed':
          disabled,
        'hover:bg-opacity-80  hover:border-opacity-80': !disabled,
        'bg-qwerty-primary text-qwerty-background': $props.primary
      }
    ]"

...
<template>
  <AppModal :show="isModalOpen" sm @modal:closed="handleClose">
    <div class="flex flex-col -mt-5 justify-center items-center">
      ...
      <NuxtLink
        class="whitespace-nowrap w-full bg-qwerty-primary text-qwerty-background rounded mb-4"
        :to="url"
        target="_blank"
        @click="handleTakeSurveyClickEvent"
      >
        <div
          class="flex items-center justify-center py-2 text-qwerty-white font-semibold text-sm"
        >
      ...
      <AppButton
        class="bg-transparent w-full hover:bg-qwerty-shade3 font-semibold text-sm"

...
<template>
  <div class="flex justify-between items-center">
    ...
    <div
      class="bg-qwerty-primary text-qwerty-background min-w-6 h-6 mx-6 flex items-center justify-center rounded-full cursor-pointer"
      data-cy="transfer-modal-direction-toggle-button"
    >
      <BaseIcon
        name="arrow"
        swap
        class="text-qwerty-white w-6 h-6 rotate-180 select-none"

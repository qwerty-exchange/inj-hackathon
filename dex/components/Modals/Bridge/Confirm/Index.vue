        ...
        <div v-if="!networkIsNotSupported">
          ...
          <div v-if="formValues[BridgeField.Token]" class="text-center my-8">
            ...
            <BaseIcon
              v-else
              name="category-alt"
              class="text-qwerty-white rounded-full w-10 h-10 mx-auto"
            />
            <p
              class="text-qwerty-white text-2xl font-bold tracking-0.4 mt-4"
            ...
            <p
              ...
              class="text-qwerty-primary text-sm tracking-0.4 mt-2"
          ...
          >
            ...
            <div
              class="bg-qwerty-primary text-qwerty-background min-w-6 h-6 mx-6 flex items-center justify-center rounded-full"
            >
              <BaseIcon
                name="arrow"
                class="text-qwerty-white w-4 h-4 rotate-180"
              />
            </div>
          ...
          <div class="text-center mt-6">
            <AppButton
              lg
              class="w-full font-semibold rounded bg-qwerty-primary text-qwerty-background"

...
<template>
  <div>
    ...
    <p
      ...
      class="text-qwerty-white text-xs my-2 flex items-center gap-2"
    >
    ...
    <div
      v-else
      class="flex items-center gap-1 text-qwerty-white hover:text-opacity-80 cursor-pointer text-sm mt-2"
    ...
    <div v-if="walletStore.addresses.length > 0">
      ...
      <p
        ...
        class="text-qwerty-red text-sm capitalize-phrase mt-1"
      >
        {{ addressErrors[0] }}
      </p>

      <AppButton
        class="w-full mt-4 text-qwerty-white bg-qwerty-primary font-semibold"
    ...
    <p class="text-xs text-qwerty-white mt-4">

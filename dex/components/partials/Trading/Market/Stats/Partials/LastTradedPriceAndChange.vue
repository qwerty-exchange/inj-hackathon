    ...
    <div v-else class="flex flex-col items-end font-mono">
      ...
      >
        ...
        <span
          ...
          :class="{
            'text-qwerty-green': percentageChangeStatus === Change.Increase,
            'text-qwerty-white': percentageChangeStatus === Change.NoChange,
            'text-qwerty-red': percentageChangeStatus === Change.Decrease
          }"
        >

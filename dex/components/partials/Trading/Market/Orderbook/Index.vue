...
<template>
  <div class="flex flex-col flex-wrap overflow-y-hidden w-full px-2">
      ...
      <div class="flex h-full w-full">
        ...
        >
          <PartialsTradingMarketOrderbookRecord
            ...
            class="bg-qwerty-background bg-opacity-20 hover:bg-purple-200 hover:bg-opacity-5"
            :class="{
    ...
    <div
      class="orderbook-middle-h bg-qwerty-background flex flex-col items-center justify-center border-t border-b"
    >
      <div class="w-full flex items-center justify-center">
        <span
          v-if="!isSpot"
          :class="{
            'text-qwerty-red': lastTradedPriceChange === Change.Decrease,
            'text-qwerty-green': lastTradedPriceChange !== Change.Decrease
          }"
        ...
        >
          <span
            class="text-qwerty-white underline font-mono text-base lg:text-sm 4xl:text-md cursor-pointer mx-2"
          >
            {{ markPriceToFormat }}
          </span>
        </CommonInfoTooltip>
      ...
      <div class="flex h-full w-full">
        ...
        >
          ...
          <PartialsTradingMarketOrderbookRecord
            ...
            class="bg-qwerty-shade2 hover:bg-qwerty-shade3"
            :class="{

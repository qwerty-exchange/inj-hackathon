...
<template>
  <div>
    ...
    <AppButton
      ...
      lg
      class="bg-qwerty-primary text-qwerty-background font-semibold w-full"
      @click="handleConnect"
    >
    ...
    <AppButton
      ...
      :disabled="disabled"
      :class="{
        'bg-qwerty-green text-qwerty-white': !disabled && !hasError && isBuy,
        'bg-qwerty-red text-qwerty-white': !disabled && !hasError && !isBuy
      }"

    ...
    <div>
      <div class="flex items-center justify-between">
        <div class="flex items-center space-x-2">
          <p class="text-xs text-qwerty-white flex items-center">
        ...
        <NuxtLink
          ...
          :to="{ name: 'account' }"
          class="text-qwerty-primary text-2xs font-semibold"
        >
        ...
        >
          <div>
            <div
              ...
              "
            >
              <p class="text-xs text-qwerty-white">
                {{ $t('marketPage.noTradingBalance') }}
              </p>

              <AppButton
                class="w-full rounded bg-qwerty-primary text-qwerty-background mt-4"
                @click="handleDeposit"
              >
                <span>
                  {{ $t('common.deposit') }}
            ...
            <div v-else>
              ...
              >
                ...
                <span class="font-mono text-qwerty-white">

  ...
  >
    <div class="flex justify-between items-center gap-2">
      <div class="col-span-1 flex justify-start items-center gap-2">
        ...
        <span
          class="text-qwerty-white font-bold tracking-wide text-sm uppercase"
        >
          {{ position.ticker }}
        </span>
      </div>
      ...
      <button
        class="bg-qwerty-red rounded-lg px-3 h-8 flex items-center justify-center"
        @click.stop="handleClosePosition"
      >
        <span class="text-xs text-qwerty-red">
    ...
    <div class="grid grid-cols-3 gap-4 pt-4">
      <div class="flex flex-col gap-1">
        <span class="text-xs text-qwerty-white">
      ...
      <div class="flex flex-col gap-1">
        <span class="text-xs text-qwerty-white text-right">
        ...
        <div class="flex items-center justify-end">
          ...
          <button
            ...
            role="button"
            type="button"
            class="border border-gray-500 text-qwerty-white w-5 h-5 flex justify-center items-center hover:text-qwerty-primary hover:border-qwerty-primary ml-2"
      ...
      <div class="flex flex-col gap-1">
        ...
        <span v-else class="font-mono text-sm text-qwerty-white">
          {{ HIDDEN_BALANCE_DISPLAY }}
        </span>
      </div>
      ...
      <div class="flex flex-col gap-1">
        ...
        <div v-if="hideBalances" class="flex items-center gap-1">
          ...
          <span class="text-sm text-qwerty-white uppercase">
            {{ market.quoteToken.symbol }}
          </span>
        </div>
      ...
      <div class="flex flex-col gap-1">
        ...
        <span
          v-if="isBinaryOptions"
          class="text-qwerty-white text-sm font-mono"
        >
          &mdash;
        </span>
        ...
        <span
          ...
          class="flex items-center justify-start text-qwerty-white text-sm font-mono"
          data-cy="open-position-leverage-table-data"
        >
          {{ effectiveLeverage.toFormat(2) }}
          <span class="text-qwerty-white text-sm font-mono">&times;</span>
        </span>

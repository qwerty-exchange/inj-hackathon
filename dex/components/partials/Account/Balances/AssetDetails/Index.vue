...
<template>
  <div
    ...
    class="fixed inset-0 lg:top-14 bg-qwerty-shade2 w-full z-40"
  >
        ...
        >
          <div class="flex items-center justify-start gap-2">
            <div class="cursor-pointer" @click="handleClose">
              <!-- TODO: ArrowLeft -->
              <BaseIcon name="arrow" class="w-4 h-4 text-qwerty-white" />
            </div>
          ...
          <div class="mt-6 border-b border-qwerty-shade3">
            <div
              v-if="accountBalance"
            ...
            >
              ...
              <span class="text-qwerty-white text-xs">
            ...
            <div class="flex flex-col gap-4 py-4">
              <div class="flex justify-between items-center">
                <span class="text-qwerty-white text-sm">
          ...
          <div class="mt-auto flex justify-between gap-4">
            <button
              class="w-full cursor-pointer h-10 flex justify-center items-center rounded-lg bg-qwerty-primary border-transparent border"

...
<template>
  <tr
    class="border-b border-qwerty-shade3 last:border-0 hover:bg-qwerty-shade3 bg-transparent px-4 py-0 overflow-hidden h-14 gap-2 transition-all max-h-20"
    ...
    <td v-else class="pr-4">
      <div class="flex items-center justify-end gap-4 col-start-2 col-span-2">
        <slot name="action">
          ...
          >
            <span class="text-qwerty-primary text-sm font-medium">
              {{ $t('account.deposit') }}
            </span>
          </div>

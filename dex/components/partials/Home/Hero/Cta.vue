...
<template>
  <div class="flex flex-col sm:block">
    <div class="flex items-center justify-start mb-8">
      ...
      <AssetLogoText class="block ml-2 h-6 text-qwerty-white" />
    </div>
    <h1
      class="text-qwerty-white font-bold text-[36px] leading-[58px] sm:text-5xl sm:leading-[60px] 3xl:leading-[72px] 3xl:text-[60px] 4xl:leading-[77px] 4xl:text-[64px] mb-8"
    >
      {{ $t('home.title') }}
    </h1>
    <p class="text-qwerty-white mt-4 text-base 3xl:text-xl mb-8">
      {{ $t('home.subtitle') }}
    </p>
    <div class="grid grid-cols-12 gap-4 text-base 3xl:text-xl">
      <div class="col-span-6 flex items-center justify-start">
        <BaseIcon
          name="lightning-fill"
          class="text-qwerty-white w-6 h-6 mr-3"
        />
        <span class="text-qwerty-white text-lg">
          {{ $t('home.fast') }}
        </span>
      </div>
      ...
      <div class="col-span-6 flex items-center justify-start">
        <BaseIcon name="gas" class="text-qwerty-white w-6 h-6 mr-3" />
        <span class="text-qwerty-white text-lg">
          {{ $t('home.gasFree') }}
        </span>
      </div>
    ...
    <AppButton
      lg
      class="bg-gray-750 text-qwerty-white mt-8 font-semibold"

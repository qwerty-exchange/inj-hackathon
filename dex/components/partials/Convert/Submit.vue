...
<template>
  <div class="w-full">
    ...
    <p v-if="highDeviation" class="text-qwerty-red text-sm mt-4">
      {{ $t('trade.execution_price_far_away_from_last_traded_price') }}
    </p>

    <p v-if="hasInsufficientBalance" class="text-qwerty-red text-sm mt-4">
      <span class="mr-1">
        {{
      ...
      <span class="text-qwerty-primary" @click="handleNavigation">

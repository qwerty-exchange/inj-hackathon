...
<template>
  <div
    class="container xl:max-w-6xl mx-auto pt-6 md:pt-12 bg-qwerty-shade2 rounded-xl mb-4 md:mb-12"
  >
    <div>
      ...
      <CommonTableHeader classes="grid grid-cols-3 md:hidden">
        ...
        >
          <span class="text-qwerty-white text-2xs font-normal">
            {{ $t('trade.market') }}
          </span>
        </AppSortableHeaderItem>
        ...
        >
          <template #prefix>
            <span class="text-qwerty-white text-xs mr-1">
              {{ $t('trade.last_price') }} /
            </span>
          </template>
      ...
      <CommonTableHeader class="grid-cols-10 3md:grid-cols-12">
        ...
        >
          <span
            class="text-qwerty-white text-2xs font-normal"
      ...
      >
        ...
        <template #empty>
          ...
          >
            <template #icon>
              <BaseIcon name="star-border" class="text-qwerty-white w-8 h-8" />
            </template>

            <span
              v-if="activeType === MarketType.Favorite"
              class="mt-2 text-xs text-qwerty-white"
            >
              {{ $t('markets.emptyDescriptionFavorites') }}
            </span>

            <span v-else class="mt-2 text-xs text-qwerty-white">

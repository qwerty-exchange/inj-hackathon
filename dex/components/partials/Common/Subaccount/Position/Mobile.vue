  ...
  <CommonTableRow v-if="market" dense>
    ...
    >
      <div class="flex items-center gap-1">
        ...
        <span class="text-qwerty-white font-semibold">
          {{ position.ticker }}
        </span>
      ...
      >
        <div
          class="flex items-center justify-center rounded-full bg-opacity-10 w-5 h-5 hover:bg-opacity-10 bg-qwerty-red text-qwerty-red"
        >
    ...
    <span class="text-qwerty-white uppercase tracking-widest text-3xs">
      {{ $t('trade.amount') }}
    </span>
    ...
    <div class="text-right">
      ...
      <div v-else class="flex justify-end items-center whitespace-nowrap">
        ...
        <span class="text-qwerty-white ml-1">/ {{ markPriceToFormat }}</span>
      </div>
    </div>
    ...
    <div class="text-right">
      ...
      <div v-else class="flex justify-end items-center">
        ...
        <div
          v-else
          :class="{
            'text-qwerty-green': pnl.gte(0) && !pnl.isNaN(),
            'text-qwerty-red': pnl.lt(0) && !pnl.isNaN()
          }"
    ...
    <div class="text-right">
      ...
      <AppNumber v-else :decimals="priceDecimals" :number="notionalValue">
        <template #addon>
          <span class="text-qwerty-white text-3xs">
    ...
    <div class="text-right">
      ...
      <div v-else class="flex items-center justify-end h-4">
        ...
        <button
          role="button"
          type="button"
          class="border border-gray-500 text-qwerty-white ml-2 px-1"

...
export enum Modal {
  ...
  Signin = 'signin',
  CreateOfferCryptoPawn = 'create-offer-crypto-pawn',
  OfferDetailsCryptoPawn = 'offer-details-crypto-pawn',
  Notify = 'notify'
}
...
export type BaseQuoteFields = Exclude<
  TradeField,
  TradeField.LimitPrice | TradeField.TriggerPrice | TradeField.BaseDenom | TradeField.QuoteDenom | TradeField.ProportionalPercentage
>

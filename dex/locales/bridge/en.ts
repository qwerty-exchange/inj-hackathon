...
export default {
  bridge: {
    ...
    available: 'Available',
    withdrawFromInjective: 'Withdraw from Qwerty',
    depositToInjective: 'Deposit to Qwerty',
    ...
    withdrawToInjectiveAddressSuccess: 'Withdraw to account successfully',
    ...
    transferTitleTooltip:
      'To trade on Qwerty, funds must be in the Trading Account.',
    ...
    defaultNote:
      'Note: It should take up to 10 seconds for your transfer to appear after your transaction has been confirmed on Qwerty',

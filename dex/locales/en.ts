...
export default {
  ...
  maintenance_subheader:
    'Check our announcements on Twitter for updates <a class="text-primary-500" href="https://twitter.com/QwertyExchange">@QwertyExchange</a>',
  maintenance_button: 'Twitter',
  maintenance_body:
    'We are constantly improving Qwerty. Please come back later. Follow the latest updates on our public status page.',
  token_allowance_successful: 'Token allowance set successful',
  disclaimer_note:
    'By connecting a wallet, you agree to the Qwerty <a rel="nofollow" href="https://qwerty.exchange/terms-and-conditions.pdf" class="text-primary-500" target="_blank" />Terms and Conditions</a>, have read the <a rel="nofollow" href="https://qwerty.exchange/privacy-policy.pdf" class="text-primary-500" target="_blank" />Privacy Policy</a> and acknowledge that you have read and understand the Injective Protocol <a rel="nofollow" href="https://qwerty.exchange/disclaimer.pdf" class="text-primary-500" target="_blank">disclaimer</a>.',
  ...
  Languages: 'Languages',
  download: 'Download',
  'Injective Chain Balance': 'Qwerty Balance',
  'ERC20 Balance': 'ERC20 Balance',
  'Join our Ecosystem now': 'Join the Injective Ecosystem!',
  'Ready to get started?': 'Qwerty Bridge',
  'Cta Note':
    'Transfer assets to Qwerty and experience lightning fast speeds, zero gas fees and a world of unlimited DeFi Markets.',
  recent_news: 'Recent news',
  injective_home_title_1: 'Qwerty eliminates all barriers to trading',
  injective_home_title_2: 'Join a global community',
  injective_home_subtitle_1:
    'Access unlimited DeFi markets. With Qwerty, you can trade any financial market on the first fast, cross-chain, low fee, secure, and fully decentralized derivatives exchange protocol. ',
  injective_home_subtitle_2:
    'Qwerty is governed entirely by the community.  Early adopters are encouraged to learn more about Qwerty products, connect with other community members, and have your say in shaping the future of the protocol.',
  gas_fees: 'Gas Fees',
  Total: 'Total',
  ...
  marketDeprecated: {
    ...
    description: ({ interpolate, named }: I18nMessageFunction) =>
      interpolate([named('ticker'), ' is no longer tradable on Qwerty Exchange.']),
  ...
  navigation: {
    ...
    affiliateProgramDescription:
      'Earn crypto commission by inviting friends to trade on Qwerty',
  ...
  terms: {
    ...
    acknowledge_2:
      'You will not in the future access this site or use QWERTY.EXCHANGE while located in the United States of America or a Restricted Territory.',
    acknowledge_3:
    ...
    acknowledge_4:
      'You are lawfully permitted to access this site and trade on QWERTY.EXCHANGE under the laws of the jurisdiction in which you reside and are located.',
    acknowledge_5:
